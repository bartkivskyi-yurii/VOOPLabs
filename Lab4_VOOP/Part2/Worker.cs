...
namespace Bartkivskyi_Lab4_VOOP_Part2
{
    internal class Worker : Human
    {
        ...
        public override void DoWork()
        {
            base.DoWork();
            PrintInfo();
            // Не можу написати сюди всі функції через параметри в дужках цього рядка: work.EngineDevelopment(eng);
            // Не можна передати параметр у функцію EngineDevelopment()
        }
    }
}